...
- **Drag to resize** and **scroll to zoom** the heatmap canvas
- **Fullscreen mode** for large sequence matrices
- **Copy alignment** to clipboard as Plain Text or FASTA format
- **Export PNG** - one-click heatmap download
- **LocalStorage** - save, browse, and restore up to 100 experiments
- **Zero dependencies** - single HTML file, works entirely offline
